...
public class EPCoreDimensionMarkers {
    ...
    public static final DimensionMarker MOON =
            GTDimensionMarkers.createAndRegister(Planet.MOON.location(), 1, () -> MOON_MARKER, null);
    public static final DimensionMarker MARS =
            GTDimensionMarkers.createAndRegister(Planet.MARS.location(), 2, () -> MARS_MARKER, null);
    public static final DimensionMarker VENUS =
            GTDimensionMarkers.createAndRegister(Planet.VENUS.location(), 4, () -> VENUS_MARKER, null);
    public static final DimensionMarker MERCURY = GTDimensionMarkers.createAndRegister(
            Planet.MERCURY.location(), 4, () -> MERCURY_MARKER, null);
    public static final DimensionMarker GLACIO =
            GTDimensionMarkers.createAndRegister(Planet.GLACIO.location(), 5, () -> GLACIO_MARKER, null);

    public static final DimensionMarker DEIMOS = GTDimensionMarkers.createAndRegister(
            EPCorePlanets.DEIMOS.location(), 2, () -> DEIMOS_MARKER, null);
    public static final DimensionMarker CERES = GTDimensionMarkers.createAndRegister(
            EPCorePlanets.CERES.location(), 3, () -> CERES_MARKER, null);
    public static final DimensionMarker GANYMEDE = GTDimensionMarkers.createAndRegister(
            EPCorePlanets.GANYMEDE.location(), 3, () -> GANYMEDE_MARKER, null);
    public static final DimensionMarker IO =
            GTDimensionMarkers.createAndRegister(EPCorePlanets.IO.location(), 4, () -> IO_MARKER, null);

    private static BlockEntry<Block> createMarker(String name) {
        return registrate()
                .block("%s_marker".formatted(name), Block::new)
